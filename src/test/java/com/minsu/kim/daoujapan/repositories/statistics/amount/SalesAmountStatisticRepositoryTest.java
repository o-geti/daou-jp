...
class SalesAmountStatisticRepositoryTest {
  ...
  void findByDeleteDtIsNullAndId() {
    ...
    //    INSERT INTO sales_amount_statistics (record_time, sales_amount, delete_dt) VALUES
    // ('2024-10-28 00:00:00', 5461947, null);
    ...
    assertThat(optionalSalesAmount.get().getRecordTime())
